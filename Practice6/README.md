...
```commandline
python index.py fit --trainer.default_root_dir 'logs/' --trainer.max_epochs 6 --data.csv_file './dataset/output.csv' --model.classes 3 --model.input_size 100 --model.hidden_size 64
